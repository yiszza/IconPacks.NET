...
internal static class LucideGenerator
{
    private static readonly string rootPath = Path.Combine(Paths.LucideIconPath, "./icons/");
    ...
    internal static async Task RunAsync()
    {
        ...
        Util.OutputIconKindFile(iconKinds, "Lucide", "Regular");
    }
}
